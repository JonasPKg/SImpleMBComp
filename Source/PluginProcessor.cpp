...
#endif
{
    ...
    floatHelper(lowCrossover, Names::Low_Mid_Corssover_Freq);
...
juce::AudioProcessorValueTreeState::ParameterLayout SimpleMBCompAudioProcessor::createParameterLayout()
{
    ...
    layout.add(std::make_unique<AudioParameterFloat>(params.at(Names::Low_Mid_Corssover_Freq), params.at(Names::Low_Mid_Corssover_Freq), NormalisableRange<float>(20, 20000, 1, 1), 500));
